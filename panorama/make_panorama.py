...
Мы извлекаем ключевые точки и просеиваем дескрипторы для обоих изображенийsследующим образом:
"""
...
Таким образом, мы отфильтровываем все мэтчи, чтобы получить лучшие. 
...
Поскольку вы знаете, что матрица гомографии необходима для выполнения преобразования, 
